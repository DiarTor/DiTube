...
class MyAccount:
    ...
    def return_only_user_details_response(self, user_id):
        ...
        format_number_with_commas = lambda number: f"{number:,}"
        user_register_date = users_collection.find_one({"user_id": user_id})["registered_at"]
        ...
        jalali_start_date = jdatetime.fromgregorian(
            datetime=datetime.datetime.strptime(user_register_date, "%Y-%m-%d %H:%M:%S"))
        user_jdate_register_date = jalali_start_date.strftime("%Y/%m/%d")
        response = usermanager.return_response_based_on_language(persian=persian.account_details.format(user_id,
                                                                                                        user_jdate_register_date,
                                                                                                        user_total_downloads,
                                                                                                        formated_user_total_downloads_size,
                                                                                                        formatted_balance,
                                                                                                        user_referrals,
                                                                                                        formatted_profit),
                                                                 english=english.account_details.format(user_id,
                                                                                                        user_register_date,
                                                                                                        user_total_downloads,
                                                                                                        formated_user_total_downloads_size,
                                                                                                        formatted_balance,
