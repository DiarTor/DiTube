...
async def handle_callback(update: Update, context: CallbackContext):
    ...
    if data != "invite_referrals" and data != "charge_account" and data != "auto_renew":
        ...
        await query.message.reply_text(f"Share this link to your friends.\nhttps://t.me/DiarTorBot?start=ref_{update.effective_user.id}")
    elif data == "charge_account":
        await query.answer("⚡️Coming Soon...")
